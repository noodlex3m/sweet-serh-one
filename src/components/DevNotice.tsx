    ...
    <div className="dev-notice-overlay">
      <div className="dev-notice-card">
        ...
        <div className="dev-notice-content">
          ...
          <p>
            Вітаємо в майстерні солодощів <strong>sweet-serh-one</strong>! Цей сайт зараз знаходиться на етапі активного тестування. 
            Ви можете вільно користуватися каталогом, кошиком та особистим кабінетом, проте реальна оплата та доставка замовлень наразі не здійснюються.
          </p>
